<?php
    ...
    $categorias = obtenerCategoriasEmpresa($conn, $_SESSION['id_usuario']);
    $proveedores = obtenerProveedoresEmpresa($conn, $_SESSION['id_usuario']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Agregar Producto - HyBox</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="content">
                ...
                <div class="form-container">
                    <form id="productForm" action="../../src/inventario/productos/crear-producto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" name="nombre_producto" required maxlength="100">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <textarea class="form-input form-textarea" name="descripcion" rows="4" placeholder="Describe las características del producto..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-input" name="precio" step="0.01" min="0" required>
                                    <div class="help-text">Precio al que se venderá el producto</div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-label">Precio de Compra</label>
                                    <input type="number" class="form-input" name="precio_compra" step="0.01" min="0">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-input" name="stock_minimo" min="0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" name="ubicacion" maxlength="100">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" name="codigo_barras" maxlength="50">
                                    <div class="help-text">Código de barras del producto</div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-label">Código Interno</label>
                                    <input type="text" class="form-input" name="codigo_interno" maxlength="50">
    ...
    <script>
        // Inicializar funcionalidades específicas de agregar producto
